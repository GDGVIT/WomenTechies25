...
export default function Track4() {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute   -top-[20vh] -left-[12vw] w-[30vw] min-w-[400px] h-[40vw] max-w-[500px] max-h-[500px] opacity-35"
        style={{
          borderRadius: "447px",
      ...
      {/* Blur shape -top left*/}
      <div
        className="absolute -bottom-[10vh] -right-[12vw] w-[40vw] min-w-[300px] h-[40vw] min-h-[400px] max-w-[500px] max-h-[500px] opacity-20"
        style={{
          borderRadius: "752px",
          background: "#659EA2",
          filter: "blur(100px)",
