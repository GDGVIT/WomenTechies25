...
export default function Track6() {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute   -bottom-[20vh] -left-[12vw] w-[30vw] min-w-[400px] h-[40vw] max-w-[500px] max-h-[500px] opacity-35"
        style={{
          borderRadius: "447px",
