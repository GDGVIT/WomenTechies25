...
const DinoScroll: React.FC<DinoScrollProps> = ({ className }) => {
  ...
  return (
    <section ref={targetRef} className={`relative h-[300vh] bg-[#191C1C] ${className}`}>
      <div className="sticky top-0 flex-col h-screen w-full items-center justify-center overflow-hidden bg-[#191C1C]">
        {/* Background glows */}
        <div
